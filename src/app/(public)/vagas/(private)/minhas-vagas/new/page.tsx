...
export default function RegisterJobPage() {
    ...
    return (
        <Card className="mx-auto max-w-lg shadow shadow-2xl">
            <CardHeader>
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            ...
                            <fieldset className="fieldset">
                                ...
                                <input type="time" required
                                       className="w-full input input-bordered rounded outline outline-1 outline-zinc-200 p-1 pl-2 cursor-pointer"/>
                            </fieldset>
                            ...
                            <div className="grid w-full gap-2 col-span-2 my-2">
                                ...
                                <Textarea placeholder="Descreva as atribuições e responsabilidades relacionadas à vaga ofertada."
                                          id="message" className='resize-none h-24'/>
                            </div>
